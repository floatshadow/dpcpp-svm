...
namespace svm_kernel {
    ...
    void update_f(SyncArray<float_type> &f,
                  ...
                  int n_instances) try {
        /*
        DPCT1038:108: When the kernel function name is used as a macro argument,
        ...
        */
        /*
        DPCT1002:110: Special case error handling if-stmt was detected. You may
    ...
    void sort_f(SyncArray<float_type> &f_val2sort, SyncArray<int> &f_idx2sort) {
        dpct::sort(thrust::cuda::par, f_val2sort.device_data(),
