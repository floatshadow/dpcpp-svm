...
extern "C" {
    ...
    void sparse_model_scikit(int row_size, float *val, int *row_ptr,
                             int *col_ptr, float *label, int svm_type,
                             int kernel_type, int degree, float gamma,
                             float coef0, float cost, float nu, float epsilon,
                             float tol, int probability, int weight_size,
                             int *weight_label, float *weight, int verbose,
                             int max_iter, int n_cores, int max_mem_size,
                             int gpu_id, int *n_features, int *n_classes,
                             int *succeed, SvmModel *model) try {
#ifdef USE_CUDA
        /*
        DPCT1001:46: The statement could not be removed.
        */
        /*
        DPCT1002:47: Special case error handling if-stmt was detected. You may
        need to rewrite this code.
        */
        /*
        DPCT1093:48: The "gpu_id" may not be the best XPU device. Adjust the
...
//        }
    ...
    void dense_model_scikit(int row_size, int features, float *data,
                            float *label, int svm_type, int kernel_type,
                            int degree, float gamma, float coef0, float cost,
                            float nu, float epsilon, float tol, int probability,
                            int weight_size, int *weight_label, float *weight,
                            int verbose, int max_iter, int n_cores,
                            int max_mem_size, int gpu_id, int *n_features,
                            int *n_classes, int *succeed, SvmModel *model) try {
        ...
        */
        /*
        DPCT1002:51: Special case error handling if-stmt was detected. You may
        need to rewrite this code.
        */
        /*
        DPCT1093:52: The "gpu_id" may not be the best XPU device. Adjust the
        selected device if needed.
        */
        /*
