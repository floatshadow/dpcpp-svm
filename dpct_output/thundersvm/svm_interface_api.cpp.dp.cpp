...
extern "C" {
    ...
    void thundersvm_train_sub(DataSet &train_dataset, CMDParser &parser,
                              char *model_file_path) try {
        ...
        if (parser.param_cmd.svm_type == SvmParam::NU_SVC) {
            ...
            for (int i = 0; i < train_dataset.n_classes(); ++i) {
                ...
                for (int j = i + 1; j < train_dataset.n_classes(); ++j) {
                    ...
                    if (parser.param_cmd.nu * (n1 + n2) / 2 > std::min(n1, n2)) {
        ...
        */
        /*
        DPCT1002:9: Special case error handling if-stmt was detected.
         * You may need to rewrite this code.
        */
        /*
        DPCT1093:10: The "parser.gpu_id" may not be the best XPU
         * device. Adjust the selected device if needed.
        */
        /*
        DPCT1003:11: Migrated API does not return error code. (*, 0)
...
//        strcat(model_file_path, "../python/");
    ...
    void thundersvm_predict_sub(DataSet &predict_dataset, CMDParser &parser,
                                char *model_file_path,
                                char *output_file_path) try {
        fstream file;
        ...
        */
        /*
        DPCT1002:13: Special case error handling if-stmt was
         * detected. You may need to rewrite this code.
        */
        /*
        DPCT1093:14: The "parser.gpu_id" may not be the best XPU
         * device. Adjust the selected device if needed.
        */
        /*
        DPCT1003:15: Migrated API does not return error code. (*, 0)
         * is inserted. You may need to rewrite this code.
        */
        0;
#endif
